...
class Rcl_Chat extends Rcl_Chat_Messages_Query{
        ...
        $content .= '<form action="" method="post">'
                ...
                if($this->file_upload){
                   $content .= '<span class="rcl-chat-uploader">'
                                . '<i class="fa fas fa-paperclip" aria-hidden="true"></i>'
                ...
                $content .= '<div class="chat-preloader-file"></div>'
                    . '<a href="#" class="recall-button chat-submit" onclick="rcl_chat_add_message(this);return false;"><i class="fa fas fa-reply"></i> '.__('Send','wp-recall').'</a>'
                . '</form>';
    ...
    function get_messages_box(){
        ...
        $content .= '<div class="chat-status"><span>......<i class="fa fas fa-pencil-alt" aria-hidden="true"></i></span></div>';
