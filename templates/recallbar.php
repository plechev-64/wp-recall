...
<div id="recallbar">
            ...
            <?php if(rcl_is_register_open()): ?>
                <div class="rcb_icon">
                    <a href="<?php echo $urls[1]; ?>" class="rcl-register">
                        <i class="far fa-address-card" aria-hidden="true"></i><span><?php _e('Register','wp-recall'); ?></span>
    ...
    <div class="rcb_right">
        ...
        <div class="rcb_right_menu">
            <i class="fa fas fa-ellipsis-h" aria-hidden="true"></i>
            <a href="<?php echo $rcl_user_URL; ?>"><?php echo get_avatar($user_ID,36); ?></a>
            <div class="pr_sub_menu">
                <?php do_action('rcl_bar_print_menu'); ?>
                <div class="rcb_line"><a href="<?php echo wp_logout_url('/'); ?>"><i class="fa fas fa-sign-out-alt" aria-hidden="true"></i><span><?php _e('Exit','wp-recall'); ?></span></a></div>
            </div>
        </div>
